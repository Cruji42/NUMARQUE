...
# Angular Migration to Latest Version

## Steps to Complete Migration

- [x] Update Node.js to latest LTS (20.x)
- [x] Update Angular CLI globally to latest
- [x] Update RxJS to 7.x
- [x] Update TypeScript to 4.9.x
- [x] Run ng update to Angular 15
